    ...
    while fire:
        ...
        if startShell[1] > display_height - ground_height:
            ...
            if enemyTankX + 15 > hit_x > enemyTankX - 15:
                damage = 25
                print("YOU caused the Critical hit")
            elif enemyTankX + 20 > hit_x > enemyTankX - 20:
                damage = 20
                print("YOU caused the Hard hit")
            elif enemyTankX + 30 > hit_x > enemyTankX - 30:
                damage = 10
                print("YOU caused the Medium hit")
...
def enemy_fireShell(x_y, tank_X, tank_Y, tur_Pos, gun_power, x_location, barrier_width, randomHeight, player_tankX, player_tankY):
    ...
    while fire:
        ...
        if startingShell[1] > display_height - ground_height:
            ...
            if player_tankX + 30 > hit_x > player_tankX - 30:
                damage = 25
                print("Enemy has fired the Critical hit")
            elif player_tankX + 40 > hit_x > player_tankX - 40:
                damage = 20
                print("Enemy has fired the Hard hit")
            elif player_tankX + 50 > hit_x > player_tankX - 50:
                damage = 10
                print("Enemy has fired the Medium hit")
            elif player_tankX + 60 > hit_x > player_tankX - 60:
                damage = 5
                print("Enemy has fired the Critical hit")
            else:
                print("Enemy did nothing")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    ...
                    #enemy Tank's movements
                    possibleMovements = ['forward', 'reverse']
                    moveIndex = random.randrange(0,2)

                    for i in range(random.randrange(0,10)):

                        if display_width * 0.3 > enemyTankX > display_width * 0.03:
                            if possibleMovements[moveIndex] == "forward":
                                enemyTankX += 25
                            elif possibleMovements[moveIndex] == "reverse":
                                enemyTankX -= 25
                            ...
                            gameDisplay.fill(green_ground,
                                             rect=[0, display_height - ground_height, display_width, display_height])
                            pygame.draw.rect(gameDisplay, brown_ground,
                                             (0, display_height - 5, display_width, display_height))
                            pygame.display.update()
                            clock.tick(FPS)
